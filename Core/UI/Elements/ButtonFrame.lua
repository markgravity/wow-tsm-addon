...
local ButtonFrame = TSM.Include("LibTSMClass").DefineClass("ButtonFrame", TSM.UI.Container)
local UIElements = TSM.Include("UI.UIElements")
UIElements.Register(ButtonFrame)
TSM.UI.ButtonFrame = ButtonFrame
...
function ButtonFrame.__init(self)
	local frame = UIElements.CreateFrame(self, "Frame", nil, nil, "ButtonFrameTemplate")
	...
	TSM.UI.TexturePacks.SetTexture(portrait, "uiFrames.TSMLogo")
...
function ButtonFrame.Release(self)
	self._layout = "NONE"
	self._backgroundColor = nil
	self._roundedCorners = false
	self._borderColor = nil
...
function ButtonFrame.SetBackgroundColor(self, color, roundedCorners)
...
-- @treturn Frame The frame object
function ButtonFrame.SetBorderColor(self, color, borderSize)
	assert(color == nil or Color.IsInstance(color) or Theme.GetColor(color))
...
-- @treturn Frame The frame object
function ButtonFrame.SetWidth(self, width)
...
-- @treturn Frame The frame object
function ButtonFrame.SetParent(self, parent)
...
-- @treturn Frame The frame object
function ButtonFrame.SetFrameLevel(self, level)
...
-- @treturn Frame The frame object
function ButtonFrame.SetStrata(self, strata)
	self._strata = strata
	return self
end
...
-- @treturn Frame The frame object
function ButtonFrame.SetScale(self, scale)
	self._scale = scale
	return self
end
...
-- @treturn Frame The frame object
function ButtonFrame.SetLayout(self, layout)
...
-- @treturn Frame The frame object
function ButtonFrame.SetMouseEnabled(self, enabled)
...
-- @treturn Frame The frame object
function ButtonFrame.SetMouseWheelEnabled(self, enabled)
...
-- @treturn Frame The frame object
function ButtonFrame.RegisterForDrag(self, button)
...
function ButtonFrame.IsMouseOver(self)
...
-- @treturn Frame The frame object
function ButtonFrame.SetHitRectInsets(self, left, right, top, bottom)
...
function ButtonFrame.StartMoving(self)
...
-- @tparam Frame self The element object
function ButtonFrame.StopMovingOrSizing(self)
	self:_GetBaseFrame():StopMovingOrSizing()
	self:_GetBaseFrame():SetMovable(false)
	return self
end

function ButtonFrame.SetPortraitIcon(name)
...
function ButtonFrame.Draw(self)
...
function ButtonFrame._GetMinimumDimension(self, dimension)
